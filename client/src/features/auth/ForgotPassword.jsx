                ...
                <div className="animate-slide-up-3">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className={`w-full border border-gray-200 rounded-[0.5rem] p-3.5 text-[0.95rem] ${!showNewPassword ? 'tracking-[0.2em]' : ''} text-gray-900 placeholder-gray-400 focus:outline-none focus:border-gray-900 focus:ring-1 focus:ring-gray-900 transition-all pr-12`}
                    />
                    <button type="button" onClick={() => setShowNewPassword(!showNewPassword)} className="absolute inset-y-0 right-0 px-3 flex items-center text-gray-400 hover:text-gray-900 outline-none transition-colors">
                      {showNewPassword ? (
