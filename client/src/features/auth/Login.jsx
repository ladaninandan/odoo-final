        ...
        <div className="absolute bottom-12 left-12 right-12 text-white z-20 pointer-events-none">
          ...
          <div className="flex justify-between items-end pointer-events-auto animate-slide-up-3">
            ...
            <div className="flex gap-4">
              <button className="text-white hover:text-[#E8C39E] transition-colors p-2 cursor-pointer">
        ...
        <div className="w-full max-w-[420px] mx-auto">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="animate-slide-up-2">
              ...
              <input 
                ...
                className={`w-full border ${errors.identifier ? 'border-red-400' : 'border-[#E0D4C8]'} rounded-[0.5rem] p-3.5 text-[0.95rem] text-[#4E342E] placeholder-[#BCAAA4] focus:outline-none focus:border-[#795548] focus:ring-1 focus:ring-[#795548] transition-all bg-[#FAF8F5]`}
              />
            ...
            <div className="animate-slide-up-3">
              ...
              <div className="relative">
                <input 
                  ...
                  className={`w-full border ${errors.password ? 'border-red-400' : 'border-[#E0D4C8]'} rounded-[0.5rem] p-3.5 text-[0.95rem] ${!showPassword ? 'tracking-[0.2em]' : ''} text-[#4E342E] placeholder-[#BCAAA4] focus:outline-none focus:border-[#795548] focus:ring-1 focus:ring-[#795548] transition-all bg-[#FAF8F5] pr-12`}
                />
                <button type="button" onClick={() => setShowPassword(!showPassword)} className="absolute inset-y-0 right-0 px-3 flex items-center text-[#BCAAA4] hover:text-[#4E342E] outline-none transition-colors">
                  {showPassword ? (
            ...
            <div className="flex justify-end pt-1 pb-1 animate-slide-up-3">
              <Link to="/forgot-password" className="text-[0.75rem] font-bold text-[#795548] hover:text-[#4E342E] transition-colors">
                Forgot Password?
              </Link>
            </div>
            ...
            <div className="animate-slide-up-4">
              <button 
                type="submit" 
                disabled={isLoading}
                className={`w-full bg-[#5D4037] hover:bg-[#3E2723] text-white font-semibold rounded-[0.5rem] py-3.5 text-[0.95rem] transition-colors disabled:opacity-80 disabled:cursor-not-allowed mt-2 flex items-center justify-center gap-2`}
              >
                {isLoading ? (
                  <>
          ...
          <div className="animate-slide-up-4" style={{ animationDelay: '0.45s' }}>
            ...
            <button 
              ...
              className="w-full border border-[#E0D4C8] rounded-[0.5rem] py-3.5 flex items-center justify-center gap-3 text-[0.9rem] font-semibold text-[#4E342E] hover:bg-[#FAF8F5] transition-colors active:bg-[#EFEBE6]"
            >
            ...
            {/* Footer */}
            <p className="mt-10 text-center text-[0.8rem] text-[#8D6E63] font-medium">
              Don't have an Account?{' '}
              <Link to="/register" className="text-[#5D4037] font-bold ml-1 hover:underline">
                Sign-up
              </Link>
            </p>
          </div>
