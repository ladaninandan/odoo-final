          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="animate-slide-up-3">
              ...
              <input 
                ...
                className={`w-full border ${errors.password ? 'border-red-400' : 'border-[#E0D4C8]'} rounded-[0.5rem] p-3.5 text-[0.95rem] tracking-[0.2em] text-[#4E342E] placeholder-[#BCAAA4] focus:outline-none focus:border-[#795548] focus:ring-1 focus:ring-[#795548] transition-all bg-[#FAF8F5]`}
              />
